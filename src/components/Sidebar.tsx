...
// import type { ArticleCategory } from "@/services/db/types"; // Removed unused import
import { useAuth } from "@clerk/clerk-react"; // Keep useAuth
import {
	// BookOpen, // Removed unused icon
	// ChevronDown, // Removed unused icon
	// ChevronRight, // Removed unused icon
	...
	// Newspaper, // Removed unused icon
	// PanelLeftClose, // Removed old icon
	// PanelLeftOpen, // Removed old icon
	Plus,
	Settings,
	// Shapes, // Removed unused icon
	SidebarClose,
	SidebarOpen,
	// Sun,
	// Video, // Removed unused icon
} from "lucide-react";
...
export default function Sidebar() {
	...
	// const [isLibraryOpen, setIsLibraryOpen] = useState(true); // Removed state
	const location = useLocation();
	const navigate = useNavigate();
	const { setCurrentView, setSelectedCategory } = useArticles(); // Restore setSelectedCategory, remove filters
	...
	const { isSignedIn, signOut } = useAuth(); // Add signOut
	...
	// Removed category definitions and icons
