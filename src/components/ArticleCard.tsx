...
import { Article, updateArticle } from '@/services/db';
        ...
        <CardContent className="p-0">
          <div className="p-4">
            {article.isRead ? (
              ...
              <div className="flex justify-between items-start mb-2">
                <span className="text-xs font-medium text-bondwise-500">Unread</span>
                <div className="flex items-center gap-1">
                  <Button
                    variant="ghost"
                    size="icon"
            ...
            <h3 className="text-lg font-medium line-clamp-2 mb-2">{article.title}</h3>
